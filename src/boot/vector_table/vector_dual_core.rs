use crate::boot::reset_dual_core;
...
#[no_mangle]
static __HOPTER_RESET_VECTOR_M7: unsafe extern "C" fn() -> ! = reset_dual_core::entry_m7;
...
#[no_mangle]
static __HOPTER_RESET_VECTOR_M4: unsafe extern "C" fn() -> ! = reset_dual_core::entry_m4;
